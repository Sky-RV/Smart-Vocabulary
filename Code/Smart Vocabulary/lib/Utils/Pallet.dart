...
class Pallet {
  ...
  static Color lightYellow = Color(0xFFF5ECCD);
  static Color lightOrange = Color(0xFFFCC8C2);
  static Color Orange = Color(0xFFFF87AB);
  ...
  static Color NeonPurple = Color(0xFF6639A6);
